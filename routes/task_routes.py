...
from services.task_service import create_task, get_user_tasks, delete_user_task, patch_user_task
...
def delete_tasks(task_id):
    user_id=request.user_id
    delete_user_task(task_id, user_id)
...
def update_tasks(task_id):
    user_id=request.user_id
    patch_user_task(task_id, user_id)
